...
<div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
    <div>
        ...
        <p class="text-slate-500 mt-1">Administra el estado y los roles de los usuarios de CIAC.</p>
    </div>
                ...
                <?php foreach ($users as $user): ?>
                    ...
                    <tr class="hover:bg-slate-50/70">
                        ...
                        <td class="px-5 py-4">
                            ...
                            <span class="inline-flex rounded-full px-3 py-1 text-xs font-bold <?= $active ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-200 text-slate-600' ?>">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex flex-wrap gap-2">
                                ...
                                <?php endforeach; ?>
                                <?php if ($userRoles === []): ?>
                                    <span class="text-sm text-amber-600 font-semibold">Sin rol asignado</span>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="px-5 py-4 text-sm text-slate-500">
                            <?= ! empty($user['last_login_at']) ? esc($user['last_login_at']) : 'Nunca' ?>
                        </td>
